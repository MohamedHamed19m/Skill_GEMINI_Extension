...
keywords: ["skill file", "SKILL.md", "add skill","create skill"]
---
...
domains or tasks—they transform AI from a general-purpose agent into a specialized agent
...
When editing the (newly-generated or existing) skill, remember that the skill is being created for another instance of Ai to use. Include information that would be beneficial and non-obvious to Ai. Consider what procedural knowledge, domain-specific details, or reusable assets would help another AI instance execute these tasks more effectively.
